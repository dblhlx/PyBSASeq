...
A [small test file](https://github.com/dblhlx/PyBSASeq/blob/master/smallTestFile.tsv) is included here for testing the Python script; just issuing the command `python PyBSASeq.py` in a terminal to test the script.
